    ...
    dynamicContent: function(eventType, data) {
      const templates = {
              ...
              },
              {
                  columns: [
                      ...
                      },
                      {
                          width: '*',
                          text: [
                              ':  SR. ' + (data.basicSalary || '0') + '/-\n',
                              ':  SR. ' + (data.housingAllowance || '0') + '/-\n',
                              ':  SR. ' + (data.transportationAllowance || '0') + '/-\n',
                              ':  SR. ' + (data.grossSalary || '0') + '/-'
                          ]
                      }
                  ],
                  fontSize: 12,
          ...
          "PSN_TransBetLEorDepSalChBudgeted": [
              ...
              {
                  text: 'Basic Salary                             :  SR. ' + (data.basicSalary || '0') + '/-\n' +
                        'Housing Allowance                 :  SR. ' + (data.housingAllowance || '0') + '/-\n' +
                        'Transportation Allowance     :  SR. ' + (data.transportationAllowance || '0') + '/-\n' +
                        'Gross Salary                            :  SR. ' + (data.grossSalary || '0') + '/-',
                  margin: [0, 0, 0, 20],
                  fontSize: 12
              },
              {
